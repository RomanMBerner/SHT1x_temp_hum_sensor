'''
Reading humidity and temperature from a Sensirion SHT1x sensor connected to a Raspberry Pi 3.
Should work with both SHT11 and SHT15 model.
Connect: SCK to pin7, DATA to pin11, GND to pin6 andVCC to pin1.
The code depends on: http://code.google.com/p/raspberry-gpio-python/
The module raspberry-gpio-python requires root privilege.
'''
...
class Sht1x(object):
    ...
    def read_rawHumidity(self): # This function implemented by RBerner
