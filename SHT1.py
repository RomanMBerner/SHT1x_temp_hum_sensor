...
while True:
	...
	#file.close()
        ...
        subprocess.call(["curl", "-i", "-XPOST", "192.168.0.17:8086/write?db=SHT1_temp_and_hum", "--data-binary", post1])
        subprocess.call(["curl", "-i", "-XPOST", "192.168.0.17:8086/write?db=SHT1_temp_and_hum", "--data-binary", post2])
        subprocess.call(["curl", "-i", "-XPOST", "192.168.0.17:8086/write?db=SHT1_temp_and_hum", "--data-binary", post3])
